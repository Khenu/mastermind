...
def get_guess(c_length) -> str:
    ...
    for _ in range(10):     # Replacing typical "While True:" After 10 attempts, player needs instructions again.
    ...
    print("Too many bad entries. Please review instructions.\n")
    return "q"
...
for attempt in range(num_guesses):
    ...
    # Get players guess or quit command
